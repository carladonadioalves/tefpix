...
export function SiteHeader() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-border/70 bg-background/95 backdrop-blur">
      <div className="mx-auto flex h-[150px] max-w-7xl items-center justify-between px-5 sm:px-8">
        <Link to="/" aria-label="TEFPIX — página inicial" className="flex shrink-0 items-center">
          <img src={logoAsset.url} alt="TEFPIX" className="h-[150px] w-auto object-contain" width={1200} height={400} />
        </Link>
